...
const CardAdvantage = ({ img, title, desc }) => {
  return (
    <div className="flex flex-col mobV:h-[440px] mobH:h-[464px] mobH:w-[376px] tabV:w-[352px] tabV:h-[472px] px-[16px] pt-[32px] mobV:mb-[16px] rounded-[16px] desc:h-[472px] desc:w-[304px] bg-backgroundSecondary">
