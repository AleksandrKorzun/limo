...
const Final = ({ setStep }) => {
  return (
    ...
    >
      <h3 className="font-latoBold mobV:text-medium text-big text-main mb-[24px] text-center">
        Thank You! Your Booking is Confirmed
      </h3>
      <p className="font-latoMedium mobV:text-small text-medium text-main desc:w-[804px] text-center mb-[40px]">
